...
class RemoveModelCommand extends Command
{
     ...
     * @var string
     */
    protected $description = 'Remove Created model by sitecore:make:model command.';
     ...
     */
    private function findFileNameBySubName(string $folder_name, string $migration_name)
    {
        $file_name = null;
